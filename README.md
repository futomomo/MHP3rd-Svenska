...
För att patcha spelet behövs `Athena's Translation Tool` (ATT) för MHP3rd, lägg dess .exe fil i roten av detta repo och använd sedan ATT för att skapa en patch eller direkt patcha ISO-filen.
